This repo is the home for all of the public Go code produced by the [Development Foundation].
...
* [Horizon Server](services/horizon): Full-featured API server for network
* [Go Horizon SDK - horizonclient](clients/horizonclient): Client for Horizon server (queries and transaction submission)
* [Go Horizon SDK - txnbuild](txnbuild): Construct transactions and operations
* [Ticker](services/ticker): An API server that provides statistics about assets and markets on the network
* [Keystore](services/keystore): An API server that is used to store and manage encrypted keys for client applications
